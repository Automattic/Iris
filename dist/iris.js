/*! Iris Color Picker - v1.0.7 - 2017-11-29
		...
		_create: function() {
			...
			if ( el.is( 'input' ) ) {
				if ( self.options.target ) {
					// if target is function, call it, passing input element for
					// relative reference/position
					if (typeof(self.options.target) === 'function') {
						self.picker = $( _html ).appendTo( self.options.target(el) );
					} else {
